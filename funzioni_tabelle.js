...
function create_data_table_ordini(stato){
    ...
    html_contenuto = popolaTabellaOrdini(stato, selected_year);
    $('#table_tbody').html(html_contenuto);
...
function create_data_table_ordini_chiusi(stato){
    ...
    html_contenuto = popolaTabellaOrdini(stato, selected_year_close);
    $('#table_tbody').html(html_contenuto);
...
function create_data_table_clienti(){
    ...
    html_contenuto = popolaTabellaClienti();
    $('#table_tbody').html(html_contenuto);
...
function create_data_table_prezzi(){
    ...
    html_contenuto = popolaTabellaPrezzi();
    $('#table_tbody').html(html_contenuto);
